...
这一维的细节可以继续回看 {{< relref "performance/gpu-opt-02-bandwidth.md" >}} 和 {{< relref "rendering/unity-rendering-01c-render-target-and-framebuffer.md" >}}。
...
更详细的 overdraw 和排序问题，可以回看 {{< relref "performance/gpu-opt-01-drawcall-overdraw.md" >}}。
...
这一维的判读，可以继续看 {{< relref "performance/gpu-opt-03-shader.md" >}} 和 {{< relref "performance/mobile-tool-03-mali-debugger.md" >}}。
...
更具体的几何和 draw call 关系，可以回看 {{< relref "rendering/unity-rendering-01b-draw-call-and-batching.md" >}} 和 {{< relref "performance/gpu-opt-07-instancing-deep.md" >}}。
...
这一步通常不是靠口头经验完成的，而是要和一套固定的检测链一起走，参考 {{< relref "performance/mobile-tool-06-read-gpu-counter.md" >}} 和 {{< relref "code-quality/device-tier-validation-matrix-baseline-and-visual-regression.md" >}}。前者负责把 counter 读对，后者负责把 baseline 和回归边界钉住。
...
更细的 counter 读法可以回看 {{< relref "performance/mobile-tool-06-read-gpu-counter.md" >}}。如果你已经知道自己当前只看某一类 GPU，也可以分别继续看 {{< relref "performance/mobile-tool-05-xcode-gpu-capture.md" >}}、{{< relref "performance/mobile-tool-03-mali-debugger.md" >}} 和 {{< relref "performance/mobile-tool-04-snapdragon-profiler.md" >}}。
...
- 上一篇：[渲染系统分档设计 01｜先定体验合同和预算合同：低档保什么，高档加什么]({{< relref "performance/rendering-tier-design-01-contracts.md" >}})
- 下一篇：[渲染系统分档设计 03｜渲染链怎么设计：Camera、Pass、RT 与中间结果的组织原则]({{< relref "performance/rendering-tier-design-03-pipeline-structure.md" >}})
