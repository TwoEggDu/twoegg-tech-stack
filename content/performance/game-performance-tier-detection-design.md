...
具体的 GPU → 档位对应表，见下一篇 [主流芯片档位参考表]({{< relref "performance/device-tier-chip-reference-four-tiers.md" >}})。
...
同款 SoC 在不同 OEM 机型上的持续性能可能相差 15~20%（原因见 [移动端硬件 02b｜持续性能]({{< relref "performance/mobile-hardware-02b-sustained-performance.md" >}})）。
...
下一篇 [主流芯片档位参考表]({{< relref "performance/device-tier-chip-reference-four-tiers.md" >}}) 给出 Apple / Qualcomm / MediaTek / Kirin 四家的具体档位对照表和 Unity 检测代码。
