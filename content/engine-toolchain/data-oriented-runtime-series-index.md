...
>
> - 偏 Unreal 大规模实体仿真：看 [Unreal Mass 深度系列索引]({{< relref "system-design/unreal-mass-series-index.md" >}})
> - 偏服务端高密度仿真：看 [高性能游戏服务端 ECS 系列索引]({{< relref "system-design/server-ecs-series-index.md" >}})
