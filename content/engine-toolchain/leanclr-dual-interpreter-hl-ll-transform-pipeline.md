...
![LeanCLR 三级 Transform](../../images/runtime-ecosystem/leanclr-triple-transform-pipeline.svg)

*图：MSIL → HL-IL → LL-IL，两级 transform 把 256 条 CIL 指令逐步转化为 298 条类型特化的 LL-IL。*
