...
如果上一篇工具链文章回答的是”那些按钮到底在给 runtime 准备什么输入”，那么这一篇回答的其实是：为什么 HybridCLR 不只是能跑热更代码，还能把 Unity 原本最难接回来的资源挂脚本链也接回来。
...
- 下一篇：<a href="{{< relref "engine-toolchain/hybridclr-call-chain-follow-a-hotfix-method.md" >}}">HybridCLR 调用链实战｜跟着一个热更方法一路走到 Interpreter::Execute</a>
