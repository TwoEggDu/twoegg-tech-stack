...
**教科书参考：**[`patterns-02-template-method.md`](../system-design/patterns/patterns-02-template-method.md)
...
**教科书参考：**[`patterns-04-builder.md`](../system-design/patterns/patterns-04-builder.md)
...
**教科书参考：**[`patterns-06-command.md`](../system-design/patterns/patterns-06-command.md)
...
**教科书参考：**[`patterns-05-facade.md`](../system-design/patterns/patterns-05-facade.md)
...
**教科书参考：**[`patterns-08-chain-of-responsibility.md`](../system-design/patterns/patterns-08-chain-of-responsibility.md)
...
**教科书参考：**[`patterns-11-adapter.md`](../system-design/patterns/patterns-11-adapter.md)
...
**参考：**[`patterns-07-observer.md`](../system-design/patterns/patterns-07-observer.md)
...
**参考：**[`patterns-09-factory.md`](../system-design/patterns/patterns-09-factory.md)
...
**参考：**[`patterns-24-pipeline.md`](../system-design/patterns/patterns-24-pipeline.md)
...
**参考（教科书未单独成篇，在其他文章有提）：**[`patterns-18-proxy.md`](../system-design/patterns/patterns-18-proxy.md) 讲到过这个变体。
...
**相关教科书（对比学习用）：**
- [`patterns-03-strategy.md`](../system-design/patterns/patterns-03-strategy.md) — Strategy 本身
- [`patterns-02-template-method.md`](../system-design/patterns/patterns-02-template-method.md) — Template Method vs Strategy 对比
...
**相关教科书：**
- [`patterns-27-di-vs-service-locator.md`](../system-design/patterns/patterns-27-di-vs-service-locator.md) — DI vs Service Locator 对比
...
1. **先读 [Template Method](../system-design/patterns/patterns-02-template-method.md)** — 理解 BuildConfig 的设计哲学（核心）
2. **再读 [Strategy](../system-design/patterns/patterns-03-strategy.md)** — 理解为什么不用它（对比）
3. **读 [Facade](../system-design/patterns/patterns-05-facade.md)** — 理解 BuildCommand 的角色
4. **读 [Builder](../system-design/patterns/patterns-04-builder.md)** — 理解 BuildPlanBuilder
5. **读 [Command](../system-design/patterns/patterns-06-command.md)** — 理解 ITiangongCommand 体系
6. **读 [DI vs Service Locator](../system-design/patterns/patterns-27-di-vs-service-locator.md)** — 理解为什么不用 DI
