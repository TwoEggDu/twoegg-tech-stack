...
{{< figure src="/images/runtime-ecosystem/coreclr-methodtable-eeclass-split.svg" caption="CoreCLR 把频繁访问的数据（vtable、GC info）放在 MethodTable，不频繁的（字段列表、反射）放在 EEClass。IL2CPP 的 Il2CppClass 没有这种分离。" >}}
