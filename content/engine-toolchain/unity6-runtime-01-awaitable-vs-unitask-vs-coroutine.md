...
**下一步应读：** [Unity 6 Awaitable 的 PlayerLoop 集成：帧时序与调度语义]({{< relref "engine-toolchain/unity6-runtime-02-awaitable-playerloop.md" >}}) — 逐 API 拆解 Awaitable 在 PlayerLoop 中的具体挂入阶段和时序行为
