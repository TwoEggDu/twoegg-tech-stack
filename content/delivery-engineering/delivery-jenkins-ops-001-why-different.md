...
- **通用 CI 经验在哪里失效** —— 开篇钩子 + 四维度速览
- **物理约束：体积与时长** —— 跨 10²-10³ 倍的 4 个指标 + 3 类失效
- **资源稀缺：License 与平台矩阵** —— 激活式 license + 不可共享 workspace
- **反向链路：符号表与崩溃栈** —— CI 从单向流程变双向闭环
- **主角反转：资源 vs 代码** —— 构建大头不是 javac
- **这些差异系统化之后**：本系列怎么响应 —— 四维度的耦合环 + 三子组划分依据
