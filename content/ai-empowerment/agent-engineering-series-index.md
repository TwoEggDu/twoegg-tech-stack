...
<section id="course-map" class="course-section" aria-labelledby="course-map-title">
  ...
  <div class="course-parts">
    ...
    <section class="course-part">
      ...
      <ol class="course-lessons">
        <li class="is-planned"><span class="lesson-id">18</span><span>Evidence Contract：把自然语言推断变成可审计工程数据</span><span class="lesson-status">计划中</span></li>
    ...
    <section class="course-part">
      ...
      <ol class="course-lessons">
        <li class="is-planned"><span class="lesson-id">24</span><span>为什么最终需要 Harness：横切能力由谁承载</span><span class="lesson-status">计划中</span></li>
        <li class="is-planned"><span class="lesson-id">25</span><span>Agent Runtime vs Harness：执行内核与工程控制面</span><span class="lesson-status">计划中</span></li>
        <li class="is-planned"><span class="lesson-id">26</span><span>Harness 的最小能力模型：Capability、Policy、Session、Trace 与 Recovery</span><span class="lesson-status">计划中</span></li>
    ...
    <section class="course-part">
      ...
      <ol class="course-lessons">
        <li class="is-planned"><span class="lesson-id">28</span><span>怎样把 DeepSeek Harness 当作 Evidence-first 源码教材</span><span class="lesson-status">计划中</span></li>
        <li class="is-planned"><span class="lesson-id">29</span><span>DeepSeek Harness 总图：从 Host 启动到一次 Agent Run</span><span class="lesson-status">计划中</span></li>
