---
title: "Budget Engineering：Token、Step、Cost 与 Latency"
slug: "agent-engineering-20-budget-engineering-token-step-cost-latency"
date: "2026-08-26T00:00:00+08:00"
description: "把 Token、Step、Cost 与 Latency 拆成多维预算合同，建立准入、预留、执行、耗尽路由与审计记录。"
draft: false
tags:
  - "Agent Engineering"
  - "AI Engineering"
...
> **上一篇**：[Permission、Approval、Human-in-the-loop 与 Sandbox]({{< relref "ai-empowerment/agent-engineering-19-permission-approval-hitl-sandbox.md" >}})
