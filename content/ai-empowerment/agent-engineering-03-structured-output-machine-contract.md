---
title: "Structured Output：让模型输出成为机器可消费的合同"
slug: "agent-engineering-03-structured-output-machine-contract"
date: "2026-08-20T00:00:00+08:00"
description: "区分 Provider envelope、Parse、Schema、DTO 与 Domain Validation，以本地 C# Lab 验证首失败边界，并明确结构正确不等于事实、执行或质量正确。"
draft: false
tags:
  - "Agent Engineering"
  - "AI Engineering"
...
> **上一篇**：[Prompt Engineering：任务合同、角色、示例与边界]({{< relref "ai-empowerment/agent-engineering-02-prompt-engineering-contract-boundaries.md" >}})
