---
title: "Agent Engineering 世界地图：从 Model、Agent 到 Harness / Host"
slug: "agent-engineering-00-agent-engineering-world-map"
date: "2026-08-19"
description: "Agent Engineering 课程入口：区分 Model、Application、Agent、Agentic、Product、Surface、Host、Runtime 与 Harness，并建立分析新 Agent 产品时的概念层与证据边界。"
draft: false
tags:
  - "Agent Engineering"
  - "AI Engineering"
