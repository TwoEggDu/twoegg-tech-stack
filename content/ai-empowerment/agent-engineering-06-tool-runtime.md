...
slug: "agent-engineering-06-tool-runtime"
date: "2026-08-20T00:00:00+08:00"
description: "建立从 Tool Call 意图到 Host 执行的 Canonicalize、Validate、Policy、Execute、Result 与 Trace 管线，并用固定 C# / .NET Lab 说明路径、取消、结果和幂等的可验证边界。"
draft: false
tags:
  - "Agent Engineering"
  - "AI Engineering"
