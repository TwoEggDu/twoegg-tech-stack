---
title: "模型调用到底发生了什么：LLM、Model API、Messages 与 Token"
slug: "agent-engineering-01-model-api-messages-token"
date: "2026-08-19"
description: "从一次 C# 模型调用出发，区分 Model、Provider、Model API、SDK 与 Application，理解 Messages、Token、Context Window、Response 和 Streaming 的工程边界。"
draft: false
tags:
  - "Agent Engineering"
  - "AI Engineering"
