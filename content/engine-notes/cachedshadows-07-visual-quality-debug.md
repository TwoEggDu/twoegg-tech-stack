...
- [unity-rendering-02b-shadow-map.md]({{< relref "engine-notes/unity-rendering-02b-shadow-map.md" >}})
- [urp-lighting-02-shadow.md]({{< relref "engine-notes/urp-lighting-02-shadow.md" >}})
...
这一层怎么拿证据，可以直接回看上一篇：[06｜怎么证明当前阴影来自哪条链路：Frame Debugger、RenderDoc、日志各看什么]({{< relref "engine-notes/cachedshadows-06-validation-and-proof.md" >}})。
