...
### [Mali 现代架构深度｜Valhall / 5th Gen 的 Execution Engine、带宽模型与移动优化含义]({{< relref "engine-notes/zero-b-deep-01-mali-modern-architecture.md" >}})
...
### [Apple GPU 深度｜Tile Memory、Memoryless Render Target、Rasterization Order 与 Metal 绑定]({{< relref "engine-notes/zero-b-deep-02-apple-gpu.md" >}})
...
- **Mali 设备花屏，但 Adreno 正常**：先看 Mali 篇的「mediump 精度行为」和「SPIR-V 驱动编译 Bug」部分，再配合 [Android Vulkan 驱动架构]({{< relref "engine-notes/android-vulkan-driver.md" >}})
