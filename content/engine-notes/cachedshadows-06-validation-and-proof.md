...
如果这里没站稳，后面的结论都不稳。  
这一层怎么拆得更细，可以直接回看 [03｜从 Quality 到 Camera：TopHeroUnity 里一个阴影是怎么真正被启用的]({{< relref "engine-notes/cachedshadows-03-activation-chain.md" >}})。
...
前置工具基础可以回看 [unity-rendering-01d-frame-debugger.md]({{< relref "engine-notes/unity-rendering-01d-frame-debugger.md" >}})。
...
- [unity-rendering-01e-renderdoc-basics.md]({{< relref "engine-notes/unity-rendering-01e-renderdoc-basics.md" >}})
- [unity-rendering-01f-renderdoc-advanced.md]({{< relref "engine-notes/unity-rendering-01f-renderdoc-advanced.md" >}})
- [urp-ext-05-renderdoc.md]({{< relref "engine-notes/urp-ext-05-renderdoc.md" >}})
...
如果下一步你面对的已经不是“来源不明”，而是“来源我知道了，但为什么画面还是锯齿、漂浮、抖动、远处断掉”，那就继续看下一篇：[07｜阴影画质问题怎么查：锯齿、漂浮、漏光、抖动，到底该调哪一层]({{< relref "engine-notes/cachedshadows-07-visual-quality-debug.md" >}})。
