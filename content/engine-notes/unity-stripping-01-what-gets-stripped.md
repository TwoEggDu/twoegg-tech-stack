...
这层删的是你项目里最终要进入构建链路的托管程序集，也就是那些 `C# -> IL` 之后的 DLL。如果对 IL 和程序集是什么还不熟，可以先看：[构建与调试前置 02c｜.NET 程序集与 IL：C# 代码到可执行文件中间那层是什么]({{< relref "engine-notes/build-debug-02c-dotnet-assembly-and-il.md" >}})
