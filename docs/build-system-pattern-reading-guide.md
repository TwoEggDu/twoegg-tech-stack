# 构建系统阅读索引 — 我们用了哪些模式，为什么

> 配合 DP + Zuma 共享构建系统的架构决策。
> 对于每个设计选择，列出对应的教科书文章，说明为什么选、为什么不选别的。
> 方案文档：[`swift-crunching-parnas.md`](C:/Users/IGG/.claude/plans/swift-crunching-parnas.md)
...
**教科书参考：**[`patterns-02-template-method.md`](../content/system-design/patterns/patterns-02-template-method.md)
...
**教科书参考：**[`patterns-04-builder.md`](../content/system-design/patterns/patterns-04-builder.md)
...
**教科书参考：**[`patterns-06-command.md`](../content/system-design/patterns/patterns-06-command.md)
...
**教科书参考：**[`patterns-05-facade.md`](../content/system-design/patterns/patterns-05-facade.md)
...
**教科书参考：**[`patterns-08-chain-of-responsibility.md`](../content/system-design/patterns/patterns-08-chain-of-responsibility.md)
...
**教科书参考：**[`patterns-11-adapter.md`](../content/system-design/patterns/patterns-11-adapter.md)
...
**参考：**[`patterns-07-observer.md`](../content/system-design/patterns/patterns-07-observer.md)
...
**参考：**[`patterns-09-factory.md`](../content/system-design/patterns/patterns-09-factory.md)
...
**参考：**[`patterns-24-pipeline.md`](../content/system-design/patterns/patterns-24-pipeline.md)
...
**参考（教科书未单独成篇，在其他文章有提）：**[`patterns-18-proxy.md`](../content/system-design/patterns/patterns-18-proxy.md) 讲到过这个变体。
...
**相关教科书（对比学习用）：**
- [`patterns-03-strategy.md`](../content/system-design/patterns/patterns-03-strategy.md) — Strategy 本身
- [`patterns-02-template-method.md`](../content/system-design/patterns/patterns-02-template-method.md) — Template Method vs Strategy 对比
...
**相关教科书：**
- [`patterns-27-di-vs-service-locator.md`](../content/system-design/patterns/patterns-27-di-vs-service-locator.md) — DI vs Service Locator 对比
...
1. **先读 [Template Method](../content/system-design/patterns/patterns-02-template-method.md)** — 理解 BuildConfig 的设计哲学（核心）
2. **再读 [Strategy](../content/system-design/patterns/patterns-03-strategy.md)** — 理解为什么不用它（对比）
3. **读 [Facade](../content/system-design/patterns/patterns-05-facade.md)** — 理解 BuildCommand 的角色
4. **读 [Builder](../content/system-design/patterns/patterns-04-builder.md)** — 理解 BuildPlanBuilder
5. **读 [Command](../content/system-design/patterns/patterns-06-command.md)** — 理解 ITiangongCommand 体系
6. **读 [DI vs Service Locator](../content/system-design/patterns/patterns-27-di-vs-service-locator.md)** — 理解为什么不用 DI
