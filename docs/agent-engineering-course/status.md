...
|---:|---|---|:---:|:---:|---|---|---|---|
| 00 | Agent Engineering 世界地图：从 Model、Agent 到 Harness / Host | 导论 | S | 否 | `EVIDENCE_READY` | `PARTIAL` | N/A | 无阻塞；7 CONFIRMED / 1 PARTIAL / 6 PROPOSAL，下一步仅 M2 Detailed Outline |
...
4. Article 00 已完成 M1：`PLANNED -> RESEARCHING -> EVIDENCE_READY`；下一允许动作仅为 M2 Detailed Outline。
