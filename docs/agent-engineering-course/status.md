...
|---:|---|---|:---:|:---:|---|---|---|---|
| 00 | Agent Engineering 世界地图：从 Model、Agent 到 Harness / Host | 导论 | S | 否 | `OUTLINE_READY` | `PARTIAL` | N/A | Outline Gate `PASSED_WITH_NOTES`；00-C06a 保持 PARTIAL，下一步仅 M3 Draft |
...
4. Article 00 已完成 M2：`PLANNED -> RESEARCHING -> EVIDENCE_READY -> OUTLINE_READY`；下一允许动作仅为 M3 Draft。
