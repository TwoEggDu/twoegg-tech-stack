# State Machine 与 Workflow：确定性骨架和 Agent Decision Point
...
- [Article 09 Published Content](../../../../content/ai-empowerment/agent-engineering-09-planning.md)
- [Lab 03 AL-04 trace](../../labs/lab-03-minimal-agent-loop/observations/run-a/trace.jsonl)
