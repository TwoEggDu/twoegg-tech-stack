# Agent Loop：Turn、Step、Decide、Act、Observe 与 Stop
...
前面的文章已经分别建立了这些边界：[Structured Output](../../../../content/ai-empowerment/agent-engineering-03-structured-output-machine-contract.md)让候选结果可解析、可分层拒绝；[Function Calling](../../../../content/ai-empowerment/agent-engineering-05-function-calling-tool-use.md)让模型表达行动意图；[Tool Runtime](../../../../content/ai-empowerment/agent-engineering-06-tool-runtime.md)负责执行 gate、Result 与 Trace；[MCP](../../../../content/ai-empowerment/agent-engineering-07-mcp-external-capability-boundary.md)标准化外部能力的协议边界。它们都没有单独证明一项任务已经形成反馈循环。
...
可复核入口包括 [Lab 03 Design / Observation](../../labs/lab-03-minimal-agent-loop/README.md)、[execution log](../../labs/lab-03-minimal-agent-loop/observations/execution-log.md)，以及 run-a 的 [terminal results](../../labs/lab-03-minimal-agent-loop/observations/run-a/case-results.jsonl)、[Tool Outcomes](../../labs/lab-03-minimal-agent-loop/observations/run-a/tool-outcomes.jsonl)、[Observations](../../labs/lab-03-minimal-agent-loop/observations/run-a/observations.jsonl)、[State snapshots](../../labs/lab-03-minimal-agent-loop/observations/run-a/states.jsonl)与 [Trace](../../labs/lab-03-minimal-agent-loop/observations/run-a/trace.jsonl)。
