...
| --- | --- | --- | --- |
| UFS-02 首课 / 1 | [从 C# 到 C++：对象由谁持有，代码怎样变成程序？](../content/engine-toolchain/ufs-02-csharp-to-cpp-ownership.md) | M0-T02 的最小原生语言桥梁 | 三文件 C++17 在 Windows GCC 8.3.0 编译、链接、运行；编译/链接/逻辑故障与 GDB 8.2.1 断点修复已验证。未在 MSVC/UE 编译，不代表读者能力通过；后续并发范围仍按 4.1 |
